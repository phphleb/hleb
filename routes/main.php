 ...
 * you must execute "php console -routes-upd" or delete the cached "routes.txt" file after making the changes.
 *
 ...
 * «php console -routes-upd» или удалить кешированный файл «routes.txt» после внесения изменений.
 */
