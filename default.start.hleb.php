...
/*
 |-----------------------------------------------------------------------------
 | Global initialization of sessions
 |-----------------------------------------------------------------------------
 |
 | Allows to set/unset session_start when loading the framework. For GET request
 | method only.
 | Default: true
 |
 |-----------------------------------------------------------------------------
 | Глобальная инициализация сессий
 |-----------------------------------------------------------------------------
 |
 | Позволяет установить/отменить session_start() при загрузке фреймворка.
 | Только для GET-метода запроса.
 | Изначально: true
 |
 */
